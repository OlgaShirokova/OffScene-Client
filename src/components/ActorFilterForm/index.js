...
import { Payment, BookmarkBorder, Theaters } from 'material-ui-icons';
import styles from './styles.css';

class ActorFilterForm extends Component {
      ...
      <form>
        <div className={styles.formContainerTopRow}>
          <div className={styles.date}>
            ...
            <Field
              ...
              format={null}
              floatingLabelText="What is the day of the performance?"
            />
          </div>
        ...
        <div className={styles.formContainerBottomRow}>
          <div className={styles.genres}>
            <Subheader inset={false} className={styles.subheader}>
              <Theaters className={styles.icon} />
              Movie Genres
            </Subheader>
            <Field
              name="genre"
              component={AutoComplete}
              floatingLabelText="Select some movie genres"
              openOnFocus
